...
class PlayerBot(Bot):
   ...
   def play_round(self):
       ...
       if self.player.id_in_group == 1:
            yield pages.PunPage, dict(pun_2=3,pun_3=0,pun_4=3,pun_5=4, pun_6=10)
       if self.player.id_in_group == 2:
            yield pages.PunPage, dict(pun_1=3, pun_3=0, pun_4=3, pun_5=4, pun_6=10)
       if self.player.id_in_group == 3:
            yield pages.PunPage, dict(pun_1=3, pun_2=0, pun_4=3, pun_5=4, pun_6=10)
       if self.player.id_in_group == 4:
            yield pages.PunPage, dict(pun_1=3, pun_2=0, pun_3=3, pun_5=4, pun_6=10)
       if self.player.id_in_group == 5:
            yield pages.PunPage, dict(pun_1=3, pun_2=0, pun_3=3, pun_4=4, pun_6=10)
       if self.player.id_in_group == 6:
            yield pages.PunPage, dict(pun_1=3, pun_2=0, pun_3=3, pun_4=4, pun_5=1)
