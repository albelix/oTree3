...
class PunPage(Page):
    ...
    def get_form_fields(self):
        ...
        if self.player.id_in_group == 1:
            return ['pun_2', 'pun_3', 'pun_4', 'pun_5', 'pun_6']
        if self.player.id_in_group == 2:
            return ['pun_1', 'pun_3', 'pun_4', 'pun_5', 'pun_6']
        if self.player.id_in_group == 3:
            return ['pun_1', 'pun_2', 'pun_4', 'pun_5', 'pun_6']
        if self.player.id_in_group == 4:
            return ['pun_1', 'pun_2', 'pun_3', 'pun_5', 'pun_6']
        if self.player.id_in_group == 5:
            return ['pun_1', 'pun_2', 'pun_3', 'pun_4', 'pun_6']
